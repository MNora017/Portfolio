...
$saisi_image = $_POST['pimage'];//htmlspecialchars($_POST['image']);
$saisi_video = $_POST['pvideo'];//htmlspecialchars($_POST['video']);
$saisi_url = $_POST['purl'];//htmlspecialchars($_POST['url']);

$update = $dbh->prepare("UPDATE projet SET nom='$saisi_nom', description='$saisi_description', image='$saisi_image', video='$saisi_video', url='$saisi_url' WHERE id='$saisi_id'");
$update->execute();
}
