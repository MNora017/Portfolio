...
<form  action="../fichier.php" methode="post" enctype="multipart/form-data"></form>
        ...
        <form method="post" action=""  enctype="multipart/form-data">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                            <input type="text" name="nom" class="centre form-control">
...
-->
            ...
            <input type="file" name="image" id="image" class="centre form-control-file">
        </div>
        ...
        { 
            ...
            if (in_array($extens, $autoriser)) {
                ...
                echo "<span> Ce fichier n'est pas une image <br> </span>" . "   "  . "
                <p> Vous devez uploader un fichier de type png, gif, jpg, jpeg. <br> ";
            }
        }
        ?>
    <br>
