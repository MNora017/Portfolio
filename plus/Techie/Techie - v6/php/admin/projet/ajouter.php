...
include_once ("../../pdo/configPDO.php");
    ...
    $sql = "INSERT INTO projet (id, nom, description, image, video, url) values('$id', '$nom', '$description', '$image', '$video', '$url')";
...
<div class="controls">
            <input name="image" id="image" type="text"  placeholder="image" value="<?php  echo !empty($image)?$image:'';?>">
